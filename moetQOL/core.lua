...
Core.MQdefault = {
    ...
    ["realidcounter"] = {state = false, desc="Add a counter that shows current out of total friends to your social window", func=Func.RealIDCounter, category=Core.FunctionCategory.UI},
    ["combattooltip"] = {state = false, desc="Hide tooltip if in combat. Select always to always hide in combat, instance to hide in combat inside instances and raid to hide in combat inside raids", func=Func.HideTooltipInCombat, custom={"always", "instance", "raid"}, category=Core.FunctionCategory.UI},
    ...
    ["combatchat"] = {state = false, desc="Fade chat when in combat. Select always to always fade chat in combat, instance to fade in combat in instances, or boss to fade when in an encounter (usually a boss)", func=Func.HideChatInCombat, custom={"always","instance","boss"}, category=Core.FunctionCategory.UI},
